(function() {
    ...
    var layout = {
        title: {text: '나스닥 종합지수 (최근 1개월)', font: { size: 16, color: '#333' }},
        xaxis: {showgrid: true, gridcolor: '#E8E8E8', fixedrange: true},
        yaxis: {showgrid: true, gridcolor: '#E8E8E8', fixedrange: true},
        hovermode: 'x unified',
        plot_bgcolor: '#FAFAFA',
        paper_bgcolor: 'white',
        legend: {x: 0, y: 1, bgcolor: 'rgba(255,255,255,0.8)', bordercolor: '#E8E8E8', borderwidth: 1},
