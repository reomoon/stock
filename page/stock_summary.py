...
def summarize_text(text: str) -> str:
    ...
    prompt = (
        "한국어로 읽고, 핵심 내용을 3개의 주요 주제로 나누어 요약해. "
        "각 주제는 반드시 '1. 2. 3.'과 같이 번호로 시작해야 하며, []괄호 없이 작성해. "
        "요약은 아래 예시와 같이 '번호. 주제'와 그에 대한 2~3줄의 핵심 내용과 중요 수치 포함해서 작성해. "
        "모든 내용은 간결하고, 존대말(공송한 말투)작성."
        "전체 요약 결과가 600 토큰 이내로 조절.\n\n"
        "[예시 형식]\n"
        "1. CPI 발표와 금리 인하 기대\n"
        "CPI 데이터가 예상보다 좋았으며, 관세 인플레이션 우려가 없음을 보여줬다고 분석했습니다.\n"
        f"{text}"
    )
